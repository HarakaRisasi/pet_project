...
####################> Get address <####################
# driver.get("https://www.rusprofile.ru/codes/")
...
# start <= find_road <= string_route_for_find_road => file_writer(path.txt) => filter =>
# string_route_for_find_road  => find_road ==> give (work.txt)
